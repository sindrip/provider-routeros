...
type WirelessSecurityProfilesInitParameters struct {
	...
	ManagementProtectionKeySecretRef *v2.SecretKeySelector `json:"managementProtectionKeySecretRef,omitempty" tf:"-"`
	...
	StaticKey0SecretRef *v2.SecretKeySelector `json:"staticKey0SecretRef,omitempty" tf:"-"`

	// (String, Sensitive) Hexadecimal representation of the key. Length of key must be appropriate for selected algorithm. See the Statically configured WEP keys section.
	// Hexadecimal representation of the key. Length of key must be appropriate for selected algorithm. See the Statically configured WEP keys section.
	StaticKey1SecretRef *v2.SecretKeySelector `json:"staticKey1SecretRef,omitempty" tf:"-"`

	// (String, Sensitive) Hexadecimal representation of the key. Length of key must be appropriate for selected algorithm. See the Statically configured WEP keys section.
	// Hexadecimal representation of the key. Length of key must be appropriate for selected algorithm. See the Statically configured WEP keys section.
	StaticKey2SecretRef *v2.SecretKeySelector `json:"staticKey2SecretRef,omitempty" tf:"-"`

	// (String, Sensitive) Hexadecimal representation of the key. Length of key must be appropriate for selected algorithm. See the Statically configured WEP keys section.
	// Hexadecimal representation of the key. Length of key must be appropriate for selected algorithm. See the Statically configured WEP keys section.
	StaticKey3SecretRef *v2.SecretKeySelector `json:"staticKey3SecretRef,omitempty" tf:"-"`
	...
	StaticStaPrivateKeySecretRef *v2.SecretKeySelector `json:"staticStaPrivateKeySecretRef,omitempty" tf:"-"`
	...
	SupplicantIdentitySecretRef *v2.SecretKeySelector `json:"supplicantIdentitySecretRef,omitempty" tf:"-"`
	...
	Wpa2PreSharedKeySecretRef *v2.SecretKeySelector `json:"wpa2PreSharedKeySecretRef,omitempty" tf:"-"`
	...
	WpaPreSharedKeySecretRef *v2.SecretKeySelector `json:"wpaPreSharedKeySecretRef,omitempty" tf:"-"`
}
