...
func (mg *DHCPServerOptionMatcher) GetTerraformResourceType() string {
	return "routeros_ip_dhcp_server_option_matcher"
}
...
// LateInitialize this DHCPServerOptionMatcher using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *DHCPServerOptionMatcher) LateInitialize(attrs []byte) (bool, error) {
	params := &DHCPServerOptionMatcherParameters{}
