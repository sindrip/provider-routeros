...
func (mg *FirewallLayer7Protocol) GetTerraformResourceType() string {
	return "routeros_ip_firewall_layer7_protocol"
}
...
// LateInitialize this FirewallLayer7Protocol using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *FirewallLayer7Protocol) LateInitialize(attrs []byte) (bool, error) {
	params := &FirewallLayer7ProtocolParameters{}
