...
func (mg *NeighborDiscoverySettings) GetTerraformResourceType() string {
	return "routeros_ip_neighbor_discovery_settings"
}
...
// LateInitialize this NeighborDiscoverySettings using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *NeighborDiscoverySettings) LateInitialize(attrs []byte) (bool, error) {
	params := &NeighborDiscoverySettingsParameters{}
