...
func (mg *Certificate) GetTerraformResourceType() string {
	return "routeros_system_certificate"
}

// GetConnectionDetailsMapping for this Certificate
func (tr *Certificate) GetConnectionDetailsMapping() map[string]string {
	return map[string]string{"challenge_password": "status.atProvider.challengePassword", "import[*].passphrase": "import[*].passphraseSecretRef", "sign_via_scep[*].challenge_password": "signViaScep[*].challengePasswordSecretRef"}
}
