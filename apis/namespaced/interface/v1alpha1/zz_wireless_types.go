...
type WirelessInitParameters struct {
	...
	Nv2PresharedKeySecretRef *v2.LocalSecretKeySelector `json:"nv2PresharedKeySecretRef,omitempty" tf:"-"`
	...
	Nv2SyncSecretSecretRef *v2.LocalSecretKeySelector `json:"nv2SyncSecretSecretRef,omitempty" tf:"-"`
