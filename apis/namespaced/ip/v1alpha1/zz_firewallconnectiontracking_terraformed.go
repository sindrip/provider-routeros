...
func (mg *FirewallConnectionTracking) GetTerraformResourceType() string {
	return "routeros_ip_firewall_connection_tracking"
}
...
// LateInitialize this FirewallConnectionTracking using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *FirewallConnectionTracking) LateInitialize(attrs []byte) (bool, error) {
	params := &FirewallConnectionTrackingParameters{}
