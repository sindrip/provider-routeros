...
// Gre is the Schema for the Gres API. #### This is an alias for backwards compatibility between plugin versions. Please see documentation for [routeros_interface_gre](interface_gre.md)
