...
type IpipInitParameters struct {
	...
	// (String) Name of the ipip interface.
...
// IpipSpec defines the desired state of Ipip
type IpipSpec struct {
	v2.ManagedResourceSpec `json:",inline"`
	ForProvider            IpipParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider IpipInitParameters `json:"initProvider,omitempty"`
}

// IpipStatus defines the observed state of Ipip.
type IpipStatus struct {
	v2.ManagedResourceStatus `json:",inline"`
	AtProvider               IpipObservation `json:"atProvider,omitempty"`
}
...
type Ipip struct {
	...
	Spec   IpipSpec   `json:"spec"`
	Status IpipStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// IpipList contains a list of Ipips
type IpipList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []Ipip `json:"items"`
}

// Repository type metadata.
var (
	Ipip_Kind             = "Ipip"
	Ipip_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: Ipip_Kind}.String()
	Ipip_KindAPIVersion   = Ipip_Kind + "." + CRDGroupVersion.String()
	Ipip_GroupVersionKind = CRDGroupVersion.WithKind(Ipip_Kind)
)

func init() {
	SchemeBuilder.Register(&Ipip{}, &IpipList{})
}
