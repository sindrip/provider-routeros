...
// Scheduler is the Schema for the Schedulers API. #### This is an alias for backwards compatibility between plugin versions. Please see documentation for [routeros_system_scheduler](system_scheduler.md)
