...
// Vlan is the Schema for the Vlans API. #### This is an alias for backwards compatibility between plugin versions. Please see documentation for [routeros_interface_vlan](interface_vlan.md)
