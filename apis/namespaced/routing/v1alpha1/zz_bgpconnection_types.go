...
type BGPConnectionInitParameters struct {
	...
	// (String) Remote AS number. If not specified BGP will determine remote AS automatically from the OPEN message.
	...
	// (Boolean) Whether to allow the router to initiate the connection.
	...
	// (Boolean) Whether to listen for incoming connections.
	...
	// (String) Name of the BGP connection.
	...
	// (String, Sensitive) The key used to authenticate the connection with TCP MD5 signature as described in RFC 2385. If not specified, authentication is not used.
	...
	TCPMd5KeySecretRef *v2.LocalSecretKeySelector `json:"tcpMd5KeySecretRef,omitempty" tf:"-"`

	// (Set of String) List of the template names, to inherit parameters from. Useful for dynamic BGP peers.
...
type BGPConnectionObservation struct {
...
type BGPConnectionParameters struct {
...
type InputInitParameters struct {
	...
	AcceptCommunities *string `json:"acceptCommunities,omitempty" tf:"accept_communities,omitempty"`
	...
	AcceptLargeCommunities *string `json:"acceptLargeCommunities,omitempty" tf:"accept_large_communities,omitempty"`
...
type LocalInitParameters struct {
	...
	// (String) Remote IPv4/6 address used to connect and/or listen to.
	// Local connection IPv4/6 address.
	Address *string `json:"address,omitempty" tf:"address,omitempty"`

	// (Number) Local connection port.
	// Local connection port.
	Port *int64 `json:"port,omitempty" tf:"port,omitempty"`

	// ietf-idr-bgp-open-policy/?include_text=1)
...
type LocalObservation struct {
	...
	// (String)
	DefaultAddress *string `json:"defaultAddress,omitempty" tf:"default_address,omitempty"`
...
type RemoteInitParameters struct {
	...
	// (String) List of remote AS numbers that are allowed to connect. Useful for dynamic peer configuration.
	// List of remote AS numbers that are allowed to connect. Useful for dynamic peer configuration.
	AllowedAs *string `json:"allowedAs,omitempty" tf:"allowed_as,omitempty"`
...
// BGPConnectionSpec defines the desired state of BGPConnection
type BGPConnectionSpec struct {
	v2.ManagedResourceSpec `json:",inline"`
	ForProvider            BGPConnectionParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider BGPConnectionInitParameters `json:"initProvider,omitempty"`
}

// BGPConnectionStatus defines the observed state of BGPConnection.
type BGPConnectionStatus struct {
	v2.ManagedResourceStatus `json:",inline"`
	AtProvider               BGPConnectionObservation `json:"atProvider,omitempty"`
}
...
// BGPConnection is the Schema for the BGPConnections API. > [!WARNING] Using this resource you may happen unexpected behavior, for example, some of the attributes may not be removable after adding them to the TF configuration. Please report this to GitHub and it may be possible to fix it. Use the resource at your own risk as it is!
...
type BGPConnection struct {
	...
	Spec   BGPConnectionSpec   `json:"spec"`
	Status BGPConnectionStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// BGPConnectionList contains a list of BGPConnections
type BGPConnectionList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []BGPConnection `json:"items"`
}

// Repository type metadata.
var (
	BGPConnection_Kind             = "BGPConnection"
	BGPConnection_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: BGPConnection_Kind}.String()
	BGPConnection_KindAPIVersion   = BGPConnection_Kind + "." + CRDGroupVersion.String()
	BGPConnection_GroupVersionKind = CRDGroupVersion.WithKind(BGPConnection_Kind)
)

func init() {
	SchemeBuilder.Register(&BGPConnection{}, &BGPConnectionList{})
}
