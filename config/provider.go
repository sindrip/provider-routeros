...
func providerForRuntime() *schema.Provider {
	return withCommentSequence(withFactoryIdentity(withCommentIdentity(withNameIdentity(injectRouterComment(injectRouterName(withoutPhantomDefaults(routeros.Provider())))))))
}
