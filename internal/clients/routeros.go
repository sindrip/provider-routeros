...
import (
	...
	namespacedv1beta1 "github.com/sindrip/provider-routeros/apis/namespaced/v1beta1"
...
const (
	...
	errUnmarshalCredentials = "cannot unmarshal RouterOS credentials as JSON"
)

// TerraformSetupBuilder returns a no-fork setup function backed by the
// official Terraform Plugin SDK provider.
func TerraformSetupBuilder(cache *routerosruntime.ClientCache) terraform.SetupFn {
	return func(ctx context.Context, client client.Client, mg resource.Managed) (terraform.Setup, error) {
		...
		if err := decoder.Decode(&struct{}{}); err != io.EOF {
			return terraform.Setup{}, errors.New(errUnmarshalCredentials + ": multiple JSON values")
		}
		meta, err := cache.Configure(ctx, configuration)
		if err != nil {
