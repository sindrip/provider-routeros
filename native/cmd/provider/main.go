...
func main() {
	...
	logging := zap.Options{Development: true}
	...
	utilruntime.Must(clusterv1beta1.SchemeBuilder.AddToScheme(scheme))
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "native.provider-routeros.sindrip.io",
	})
	if err != nil {
