module github.com/sindrip/routeros/tools
...
require (
	...
	honnef.co/go/tools v0.8.0-rc.1 // indirect; forced over golangci-lint's v0.7.0, which predates go1.27 — drop when it catches up
